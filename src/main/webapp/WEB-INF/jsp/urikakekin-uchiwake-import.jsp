                ...
                <ul class="metismenu" id="menu1">
                    <li>
                        <a class="has-arrow" href="#" aria-expanded="false"><span
                                class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Manage users</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="list users" href="/list-user"><span class="mini-sub-pro">List users</span></a>
                            </li>
                    ...
                    <li class="active">
                        <a class="has-arrow" href="#" aria-expanded="false"><span
                                class="educate-icon educate-data-table icon-wrap"></span> <span class="mini-click-non">Data import</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="Urikakekin zandaka" href="/import-file/maeukekin"><span class="mini-sub-pro">前受金リスト</span></a>
                            </li>
                            <li><a title="RP nyuukin deta" href="/import-file/urikakezandakauchiwake"><span
                                    class="mini-sub-pro">売掛金残高内訳表</span></a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="#" aria-expanded="false"><span
                                class="educate-icon educate-pages icon-wrap"></span> <span class="mini-click-non">Data export</span></a>
                        <ul class="submenu-angle page-mini-nb-dp" aria-expanded="false">
                            <li><a title="Mae-ukekin" href="/export-file/maeukekin"><span
                                    class="mini-sub-pro">前受金リスト</span></a></li>
                            <li><a title="Urikake-zandaka-uchiwake" href="/export-file/urikakezandakauchiwake"><span
                                    class="mini-sub-pro">売掛金残高内訳表</span></a></li>
                        </ul>
                    </li>
                </ul>
...
<div class="all-content-wrapper">
                        ...
                        <div class="mobile-menu">
                            <nav id="dropdown">
                                <ul class="mobile-menu-nav">
                                    <li><a data-toggle="collapse" data-target="#Tablesmob" href="#">Contract <span
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">売掛金残高内訳表</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <div class="basic-form-area mg-b-15">
        <div class="container-fluid">
            ...
            <f:form method="post"
                    action="/upload/urikakezandakauchiwake" enctype="multipart/form-data">
                <div class="form-group-inner">
                    <div class="row">
                        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                            <label class="login2 pull-right pull-right-pro">売掛金残高内訳表</label>
                            <div class="import-notice pull-right pull-right-pro">
                        ...
                        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                            <div class="file-upload-inner ts-forms">
                                <div class="input prepend-big-btn">
                                    <label class="icon-right" for="prepend-big-btn-1">
                                        <i class="fa fa-download"></i>
                                    </label>
                                    <div class="file-button">
                                        Browse
                                        <input type="file" name="file" accept=".xls,.xlsx,.csv"
                                               onchange="document.getElementById('prepend-big-btn-1').value = this.value;"/>
                                    </div>
                                    <input type="text" id="prepend-big-btn-1" placeholder="no file selected">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                    <button class="btn btn-sm btn-primary login-submit-cs" type="submit">Save Change
                                    </button>
                                    <button class="btn btn-white" id="urikakekin-uchiwake-import-cancel">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
