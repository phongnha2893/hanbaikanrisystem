    ...
    <div class="basic-form-area mg-b-15">
        <div class="container-fluid">
           <div class="row">
            ...
            <f:form method="post"
                    action="/upload/maeukekin" enctype="multipart/form-data">
                            ...
                            <div class="file-upload-inner ts-forms">
                                <div class="input prepend-big-btn">
                                    ...
                                    <div class="file-button">
                                        Browse
                                        <input type="file" name="file" accept=".xls,.xlsx,.csv" onchange="document.getElementById('prepend-big-btn').value = this.value;">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                    ...
                                    <button class="btn btn-white" id="maeukekin-import-cancel">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
